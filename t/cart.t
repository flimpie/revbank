...
use_ok('SpaceTab::Cart');
use_ok('SpaceTab::Cart::Entry');

sub test_add_entry {
my $cart = SpaceTab::Cart->new();
my $entry = SpaceTab::Cart::Entry->new(100, "test");
...
isa_ok($entry, 'SpaceTab::Cart::Entry', "add should return a Cart Entry object");
...
sub test_select {
my $cart = SpaceTab::Cart->new();
my $entry1 = SpaceTab::Cart::Entry->new(100, "test1");
my $entry2 = SpaceTab::Cart::Entry->new(200, "test2");
...
#sub test_display {
#    my $cart = SpaceTab::Cart->new;
#    my $entry1 = SpaceTab::Cart::Entry->new(-500, "Groceries");
#    my $entry2 = SpaceTab::Cart::Entry->new(-100, "Coffee");
#    $cart->add_entry($entry1);
#    $cart->add_entry($entry2);
