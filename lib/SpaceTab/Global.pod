...
SpaceTab::Global - Constants and utility functions
...
Return codes for plugins. See L<SpaceTab::Plugins>.
...
See C<call_hooks> in L<SpaceTab::Plugins>.
...
See C<parse_user> in L<SpaceTab::Users>.
