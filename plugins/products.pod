...
id appears multiple times within C<data/products>, the I<last> one is used.
...
C<data/products>. User accounts are liability accounts.)
...
The addon product must be specified in C<data/products>; market products
